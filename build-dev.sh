...
# 4.container
docker run -dit --stop-timeout 120 --name wls-app.$(date +%F) --network bridge -p 7001:7001/tcp -p 9002:9002/tcp oracle/weblogic:12.2.1.2-generic_custom.$(date +%F); docker logs --follow wls-app.$(date +%F)
